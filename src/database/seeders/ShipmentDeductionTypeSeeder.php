...
class ShipmentDeductionTypeSeeder extends Seeder
{
    public function run()
    {
        ...
        $driverAndBusboyTypes = [
            'PHỤ CẤP TÀI 2', 'PHỤ CẤP TÀI 3', 'BỐC XẾP', 'PHÍ CẦU ĐƯỜNG', 'PHỤ CẤP CHỦ NHẬT', 'PHỤ CẤP ĐI XA', 'PHỤ CẤP SỚM/ĐÊM', 'PHỤ CẤP LƠ', 'PHỤ CẤP CƠM TỐI', 'PHỤ CẤP CƠM NGÀY', 'CHI PHÍ KHÁC', 'TIỀN TỰ CẦU', 'TIỀN CẦU THÊM', 'PC CHẠY MOOC LÙN', 'BỒI DƯỞNG LÊN XUỐNG HÀNG', 'ĐI SỚM - KHUYA ĐÊM', 'PHÍ CÔNG AN'
        ];
        // Chi phí thuê xe
