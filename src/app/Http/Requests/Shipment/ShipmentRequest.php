...
class ShipmentRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'comp_destination' => 'nullable|string|max:255',
            'comp_destination2' => 'nullable|string|max:255',
            'comp_destination3' => 'nullable|string|max:255',
    ...
    public function attributes()
    {
        return [
            ...
            'company2' => 'Công ty 2',
            'company3' => 'Công ty 3',
            'comp_destination' => 'Điểm đến công ty',
