...
class ShipmentRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'address_origin2' => 'nullable|string|max:255',
            'address_origin3' => 'nullable|string|max:255',
    ...
    public function attributes()
    {
        return [
            ...
            'address_origin' => 'Địa chỉ điểm đi',
            'address_origin2' => 'Địa chỉ điểm đi 2',
            'address_origin3' => 'Địa chỉ điểm đi 3',
            'address_destination' => 'Điểm đến địa chỉ',
