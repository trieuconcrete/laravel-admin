...
class ShipmentService
{
    ...
    public function __construct(ShipmentRepositoryInterface $shipmentRepository, FileUploadService $fileUploadService)
    {
    ...
    public function createShipment($data)
    {
        ...
        return DB::transaction(function () use ($data) {
            ...
            $shipmentData = [
                ...
                'address_origin' => $data['address_origin'] ?? null,
                'address_origin2' => $data['address_origin2'] ?? null,
                'address_origin3' => $data['address_origin3'] ?? null,
                'address_destination' => $data['address_destination'] ?? null,
                'address_destination2' => $data['address_destination2'] ?? null,
                'address_destination3' => $data['address_destination3'] ?? null,
                'product_name' => $data['product_name'] ?? null,
                'product_name2' => $data['product_name2'] ?? null,
                'product_name3' => $data['product_name3'] ?? null,
