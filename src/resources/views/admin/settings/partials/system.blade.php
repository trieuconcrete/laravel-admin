<form action="{{ route('admin.settings.update', 'system') }}#system" method="POST">
    @csrf
    <input type="hidden" name="group" id="settingGroup" value="system">
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3 form-check form-switch">
                <input class="form-check-input" type="checkbox" id="maintenance_mode" name="system[maintenance_mode]" value="1"
                    {{ old('system.maintenance_mode', $settings['system']->where('key', 'maintenance_mode')->first()->value ?? false) ? 'checked' : '' }}>
