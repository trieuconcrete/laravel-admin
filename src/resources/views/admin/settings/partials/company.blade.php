<form action="{{ route('admin.settings.update', 'company') }}#system" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control number" id="social_insurance_contribution_amount"
                            name="company[social_insurance_contribution_amount]"
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="social_insurance_contribution_rate"
                            name="company[social_insurance_contribution_rate]"
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                <label for="company_bank_account" class="form-label">Tài khoản ngân hàng <span
                        class="text-danger">*</span></label>
                <input type="text" class="form-control" id="company_bank_account"
                    name="company[company_bank_account]" required
                    value="{{ old('company.company_bank_account', $settings['company']->where('key', 'company_bank_account')->first()->value ?? '') }}">
            </div>

            <div class="mb-3">
                <label for="company_bank_name" class="form-label">Ngân hàng <span
                        class="text-danger">*</span></label>
                <input type="text" class="form-control" id="company_bank_name" name="company[company_bank_name]"
                    required
            ...
            <div class="mb-4">
                ...
                <input type="file" name="company[company_logo]" id="company_logo"
                ...
                @if ($logoPath)
                    <div class="mt-2">
                        <img id="company_logo_preview"
                            ...
                            class="w-24 h-24 rounded-full mt-4 object-cover" alt="Logo Preview">
                    </div> @endif
            </div>
        </div>
    </div>
