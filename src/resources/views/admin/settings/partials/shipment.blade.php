<div class="col-md-6">
    <div class="mb-3">
        <label for="default_distance_unit" class="form-label">Đơn vị khoảng cách mặc định</label>
    ...
    <div class="mb-3">
        <label for="default_weight_unit" class="form-label">Đơn vị trọng lượng mặc định</label>
...
<div class="col-md-6">
    ...
    <div id="shipment_code_prefix_container" class="mb-3 {{ old('shipment.auto_generate_shipment_code', $settings['shipment']->where('key', 'auto_generate_shipment_code')->first()->value ?? true) ? '' : 'd-none' }}">
        <label for="shipment_code_prefix" class="form-label">Tiền tố mã vận chuyển</label>
