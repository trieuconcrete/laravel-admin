                                ...
                                <table class="table table-hover align-middle table-nowrap mb-0">
                                    <thead class="table-light text-uppercase">
                                        <tr>
                                            ...
                                            <th>BHXH ({{ \App\Models\Setting::get('social_insurance_contribution_rate', 10.5) }}%) <small class="text-muted" title="Mức đóng theo mức đóng lương cá nhân của nhân viên">ⓘ</small></th>
                                            <th>Tổng lương</th>
                                            <th>Trạng thái</th>
                                        </tr>
                                    </thead>
