                                            ...
                                            <div class="origin-destination bg-light p-3 mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập địa chỉ đi" name="company" value="{{ old('company', $shipment->company) }}">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nhập Địa chỉ đến" name="address_destination" value="{{ old('address_destination', $shipment->address_destination) }}">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" placeholder="Nhập địa chỉ đi 2" name="company2" value="{{ old('company2', $shipment->company2) }}">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" placeholder="Nhập Địa chỉ đến 2" name="address_destination2" value="{{ old('address_destination2', $shipment->address_destination2) }}">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" placeholder="Nhập địa chỉ đi 3" name="company3" value="{{ old('company3', $shipment->company3) }}">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control" placeholder="Nhập Địa chỉ đến 3" name="address_destination3" value="{{ old('address_destination3', $shipment->address_destination3) }}">
