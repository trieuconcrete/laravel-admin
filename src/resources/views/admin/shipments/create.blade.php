                                        ...
                                        <div class="tab-pane active" id="driverAllowance" role="tabpanel">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" name="departure_time" value="{{ old('departure_time', \Carbon\Carbon::now()->format('Y-m-d')) }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" name="estimated_arrival_time" value="{{ old('estimated_arrival_time', \Carbon\Carbon::now()->addWeek()->format('Y-m-d')) }}">
