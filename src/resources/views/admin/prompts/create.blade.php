...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Tạo Prompt mới</h1>
            ...
            <form action="{{ route('admin.prompts.store') }}" method="POST">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('example_output') is-invalid @enderror" 
                                      id="example_output" name="example_output" rows="5">{{ old('example_output') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('variable_descriptions') is-invalid @enderror" 
                                      id="variable_descriptions" name="variable_descriptions" rows="5">{{ old('variable_descriptions') }}</textarea>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save me-2"></i>Lưu Prompt
                    </button>
                </div>
            </form>
        </div>
